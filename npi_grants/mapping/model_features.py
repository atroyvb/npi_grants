...
class StringDistanceFeatures():
    ...
    def combine_prediction_data(self, grants: pd.DataFrame, npi: pd.DataFrame) -> pd.DataFrame:
        ...
        grants = grants.iloc[0:100].add_prefix('grant_').str.lower()
        npi = npi.iloc[0:100].add_prefix('npi_').str.lower()
        grants['merge_val'] = 1
        npi['merge_val'] = 1
...
if __name__ == '__main__':
    ...
    grants_df = grants.read_grants_year(2022)
    npi_df = npi.read('data/npidata_pfile_20050523-20240211.csv')
